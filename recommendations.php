    ...
    <div name="body2" class="body2">
        <div name="body2-recommend" class="body2-recommend">
            <a href="recommendations.php">
                <h2>New Product Available: Our LOVABLE Matt!</h2>
            </a>
        </div>
    ...
    <div name="body1" class="body1">
        <div class="row">
                ...
                <div class="col-8" style="padding-top = 5em">
                    ...
                    <p>This week's best selling product is our LOVABLE Scrub - Coconut! With the winter season coming around the corner, we need to keep our lips nice and smooth! Get yours today!</p>
                </div>
        </div>
    </div>
