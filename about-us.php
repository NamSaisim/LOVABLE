...
<body>
    ...
    <div name="body1" class="body1">
        ...
        <div class="body1-description">
            ...
            <p>We created this business from scratch in hopes to booth everyone's confident while wearing our LOVABLE lip products. Our ingredients are all organic to provide the most moisture possible.</p>
        </div>
    </div>
